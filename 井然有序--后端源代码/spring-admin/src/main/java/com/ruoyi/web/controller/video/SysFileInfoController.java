...
import com.ruoyi.video.service.ISysFileInfoService;
...
public class SysFileInfoController extends BaseController
{
     ...
     * 查询文件信息列表
     */
    @PreAuthorize("@ss.hasPermi('video:info:list')")
    @GetMapping("/list")
     ...
     * 导出文件信息列表
     */
    @PreAuthorize("@ss.hasPermi('video:info:export')")
     ...
     * 获取文件信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('video:info:query')")
     ...
     * 新增文件信息
     */
    @PreAuthorize("@ss.hasPermi('video:info:add')")
     ...
     * 修改文件信息
     */
    @PreAuthorize("@ss.hasPermi('video:info:edit')")
     ...
     * 删除文件信息
     */
    @PreAuthorize("@ss.hasPermi('video:info:remove')")
