...
xml_dir = '/root/yolov8-ultralytics-main/data/NEU-DET/NEU-DET/train/annatation'
output_dir = '/root/yolov8-ultralytics-main/data/NEU-DET/NEU-DET/train/labels'  # Output directory for YOLO format files

test_xml_dir = '/root/yolov8-ultralytics-main/data/NEU-DET/NEU-DET/test/annatation'
test_output_dir = '/root/yolov8-ultralytics-main/data/NEU-DET/NEU-DET/test/labels'  # Output directory for YOLO format files
